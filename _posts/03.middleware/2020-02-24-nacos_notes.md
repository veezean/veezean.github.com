...
## 5 使用篇： Dubbo使用Nacos作为服务注册管理中心

### 5.1 pom.xml中引入Nacos依赖
...
### 5.2 application.properties中增加地址配置

```properties
dubbo.registry.address=nacos://172.31.236.126:8848
```

### 5.3 provider按照正常SpringBoot方式提供controller接口
